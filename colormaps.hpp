...
std::array<std::array<float, 3>,256> _magma_data = {{
...
std::array<std::array<float, 3>,256> _inferno_data = {{
                 ...
                 {0.985309, 0.9962365, 0.6379705},
                 {0.988362, 0.998364, 0.644924}}};

std::array<std::array<float, 3>,256> _plasma_data = {{
...
std::array<std::array<float, 3>,256> _viridis_data = {{
...
std::array<std::array<float, 3>,256> _cividis_data = {{
...
std::array<std::array<float, 3>,256> _turbo_data = {{
...
std::array<std::array<float, 3>,256> _berlin_data = {{
...
std::array<std::array<float, 3>,256> _managua_data = {{
...
std::array<std::array<float, 3>,256> _vanimo_data = {{
...
std::map<std::string, std::array<std::array<float, 3>, 256>> cmaps{
    {"magma", _magma_data},
